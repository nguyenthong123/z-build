...
const MobileNav = ({ mode, activePage, onNavigate, user, isAdminUser, handleLoginRequired, setView, onToggleChatBot, detailProduct }) => {
  ...
  const adminTabs = [
    ...
    { id: 'ai-assistant', label: 'Trợ lý AI', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a4 4 0 0 1 4 4v1h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2V6a4 4 0 0 1 4-4z"/><circle cx="9" cy="13" r="1"/><circle cx="15" cy="13" r="1"/><path d="M9 17c.83.67 2 1 3 1s2.17-.33 3-1"/></svg>, action: () => window.dispatchEvent(new Event('toggle-admin-ai-chat')) }
  ];
